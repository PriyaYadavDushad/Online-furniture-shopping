                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $get_product['0']['mrp']?></li>
                                    <li><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $get_product['0']['price']?></li>
                                </ul>
